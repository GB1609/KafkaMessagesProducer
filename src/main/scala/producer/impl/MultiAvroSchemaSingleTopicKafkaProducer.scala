...
case class MultiAvroSchemaSingleTopicKafkaProducer(server: String, schemaRegistry: String, clientID: String)
  ...
  override def getProducer: KafkaProducer[String, GenericRecord] = {
    ...
    //    props.put("value.schema", "$(<src/main/resources/schema/carSchema.avsc)")
